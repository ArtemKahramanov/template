	<ul class="cd-items cd-container">
		<li class="cd-item">
			<img src="/wordpress_test/wp-content/uploads/2017/04/item-1.jpg" alt="Item Preview">
	...
	<div class="cd-quick-view">
		<div class="cd-slider-wrapper">
			<ul class="cd-slider">
				<li class="selected"><img src="/wordpress_test/wp-content/uploads/2017/04/item-1.jpg" alt="Product 1"></li>
				<li><img src="/wordpress_test/wp-content/uploads/2017/04/item-2.jpg" alt="Product 2"></li>
				<li><img src="/wordpress_test/wp-content/uploads/2017/04/item-3.jpg" alt="Product 3"></li>
			</ul> <!-- cd-slider -->
